...
func (c *routeServiceClient) AddRoute(ctx context.Context, in *AddRouteRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/crispy.route.RouteService/AddRoute", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routeServiceClient) RemoveRoute(ctx context.Context, in *RemoveRouteRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/crispy.route.RouteService/RemoveRoute", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *routeServiceClient) GetState(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetStateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/crispy.route.RouteService/GetState", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _RouteService_AddRoute_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/crispy.route.RouteService/AddRoute",
	}
...
func _RouteService_RemoveRoute_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/crispy.route.RouteService/RemoveRoute",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _RouteService_GetState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/crispy.route.RouteService/GetState",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var RouteService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "crispy.route.RouteService",
